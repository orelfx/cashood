...
export function forecastFund(fund,cfg,live,series,{now=Date.now(),paths=10000}={}){
 ...
 return {...meta,enough:true,sharePriceNow:units?live.totalUsd/units:null,baseCapital:base,costs,
  ...
  lossProfile:null,market:null,method:`Bootstrap ${daily.length} hari tervalidasi, ${paths} lintasan. Peluang yang ditulis <0,001% berarti kejadiannya tidak muncul dalam undian — bukan berarti mustahil.`,
